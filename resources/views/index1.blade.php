...
<header>
    ...
    <div class="head_container flex">
        <a href="index.php" class="head_logo">
            <img src="{{ asset('img/logo.png') }}">
        </a>
...
<section id="sec1">
    ...
    <div class="sec1_box">
        ...
        <div class="sec1_text">
            <p>- 200 наименований оборудования</p>
    ...
    <div class="sec1_line_box mob_none">
        ...
        <div class="sec1_video_box">
            ...
            <div class="sec1_video_item">
                <div class="sec1_video_item_box" data-src="/video/2.mp4">
                    <img src="{{ asset('img/admin/sec1_v1.jpg') }}">
                </div>
                <div class="sec1_video_circle"></div>
            </div>
            ...
            <div class="sec2_info_right">
                <div class="sec2_iright_box owl-carousel" id="sec2sl1">
                    <div class="sec2_iright_item">
                        <div class="sec2_iright_ibox" data-tip="video" data-src="/video/otzyv.mp4">
                            <video src width="100%" height="100%" controls></video>
                            <div class="sec2_item_pl">
                                <img src="{{ asset('img/admin/sec2_im.jpg') }}" class="sec2_item_img">
                    ...
                    <div class="sec2_iright_item">
                        <div class="sec2_iright_ibox" data-tip="image" data-src="">
                            <video src width="100%" height="100%" controls></video>
                            <div class="sec2_item_pl">
                                <img src="{{ asset('img/admin/sec2_1im1.jpg') }}" class="sec2_item_img">
                                <div class="sec2_video_icon flex center align-center">
                                    <img src="{{ asset('img/video_icon.png') }}">
                                </div>
                            </div>
                ...
                <div class="sec2_iright_box owl-carousel" id="sec2sl2">
                    ...
                    <div class="sec2_iright_item">
                        <div class="sec2_iright_ibox" data-tip="image" data-src="">
                            <video src width="100%" height="100%" controls></video>
                            <div class="sec2_item_pl">
                                <img src="{{ asset('img/admin/sec2_2im2.jpg') }}" class="sec2_item_img">
                                <div class="sec2_video_icon flex center align-center">
                                    <img src="{{ asset('img/video_icon.png') }}">
                                </div>
                            </div>
                    ...
                    <div class="sec2_iright_item">
                        <div class="sec2_iright_ibox" data-tip="image" data-src="">
                            <video src width="100%" height="100%" controls></video>
                            <div class="sec2_item_pl">
                                <img src="{{ asset('img/admin/sec2_2im3.jpg') }}" class="sec2_item_img">
                                <div class="sec2_video_icon flex center align-center">
                                    <img src="{{ asset('img/video_icon.png') }}">
                                </div>
                            </div>
                ...
                <div class="sec2_iright_box owl-carousel" id="sec2sl3">
                    ...
                    <div class="sec2_iright_item">
                        <div class="sec2_iright_ibox" data-tip="image" data-src="">
                            <video src width="100%" height="100%" controls></video>
                            <div class="sec2_item_pl">
                                <img src="{{ asset('img/admin/sec2_3im1.jpg') }}" class="sec2_item_img">
                                <div class="sec2_video_icon flex center align-center">
                                    <img src="{{ asset('img/video_icon.png') }}">
                                </div>
                            </div>
                ...
                <div class="sec2_iright_box owl-carousel" id="sec2sl4">
                    ...
                    <div class="sec2_iright_item">
                        <div class="sec2_iright_ibox" data-tip="image" data-src="">
                            <video src width="100%" height="100%" controls></video>
                            <div class="sec2_item_pl">
                                <img src="{{ asset('img/admin/sec2_4im1.jpg') }}" class="sec2_item_img">
                                <div class="sec2_video_icon flex center align-center">
                                    <img src="{{ asset('img/video_icon.png') }}">
                                </div>
                            </div>
                ...
                <div class="sec2_iright_box owl-carousel" id="sec2sl5">
                    ...
                    <div class="sec2_iright_item">
                        <div class="sec2_iright_ibox" data-tip="image" data-src="">
                            <video src width="100%" height="100%" controls></video>
                            <div class="sec2_item_pl">
                                <img src="{{ asset('img/admin/sec2_5im1.jpg') }}" class="sec2_item_img">
                                <div class="sec2_video_icon flex center align-center">
                                    <img src="{{ asset('img/video_icon.png') }}">
                                </div>
                            </div>
                ...
                <div class="sec2_iright_box owl-carousel" id="sec2sl6">
                    ...
                    <div class="sec2_iright_item">
                        <div class="sec2_iright_ibox" data-tip="image" data-src="">
                            <video src width="100%" height="100%" controls></video>
                            <div class="sec2_item_pl">
                                <img src="{{ asset('img/admin/sec2_6im1.jpg') }}" class="sec2_item_img">
                                <div class="sec2_video_icon flex center align-center">
                                    <img src="{{ asset('img/video_icon.png') }}">
                                </div>
                            </div>
    ...
    <div class="sec4_info">
        ...
        <div class="sec4_item_line sec4_l1">
            <div class="sec4_item_top">
                ...
                <div class="sec4_item_title">365</div>
                <div class="sec4_item_text">
                    дней в году мы доступны для сотрудничества с Вами
                </div>
            </div>
            <div class="sec4_item_bottom">
                ...
                <div class="sec4_item_text">
                    голов света Martin, Robe, Claypaky и другие
                </div>
            </div>
        ...
        <div class="sec4_item_line sec4_l2">
            ...
            <div class="sec4_item_bottom">
                ...
                <div class="sec4_item_title">200</div>
                <div class="sec4_item_text">
                    квадратов LED дисплеев разных разрешений
                </div>
            </div>
        ...
        <div class="sec4_item_line sec4_l3">
            ...
            <div class="sec4_item_bottom">
                <div class="mob_block sec4_mobpuls2"></div>
                <div class="sec4_item_title">100</div>
                <div class="sec4_item_text">
        ...
        <div class="sec4_item_line sec4_l4">
            <div class="sec4_item_top">
                <div class="mob_block sec4_mobpuls2"></div>
                <div class="sec4_item_title">12</div>
                <div class="sec4_item_text">
        ...
        <div class="sec4_item_line sec4_l5">
            <div class="sec4_item_top">
                ...
                <div class="sec4_item_title">200 кВт</div>
                <div class="sec4_item_text">
            ...
            <div class="sec4_item_bottom">
                <div class="mob_block sec4_mobpuls2"></div>
                <div class="sec4_item_title">10-10 000</div>
                <div class="sec4_item_text">
...
<section id="sec6">
    ...
    <div class="sec6_title1">Эффектные мероприятия</div>
    ...
    <div class="sec6_info">
        <div class="sec6_info_box active" data-id="1">
            <div class="sec6_info_left">
                <div class="sec6_left_img active" data-im="1">
                    <img src="{{ asset('img/admin/sec6_im.jpg') }}">
                </div>
                <div class="sec6_left_img" data-im="2">
                    <img src="{{ asset('img/admin/sec6_im.jpg') }}">
                </div>
                <div class="sec6_left_img" data-im="3">
                    <img src="{{ asset('img/admin/sec6_im.jpg') }}">
                </div>
            </div>
            <div class="sec6_info_right">
                <div class="sec6_info_slider owl-carousel" id="sec6sl1">
                    <div class="sec6_info_item" data-im="1">
                        <div class="sec6_item_top">
                            <div class="sec6_item_title">Название:</div>
                            <div class="sec6_item_text1">
                                <span>Концерт</span> Jah Khalib 2019
                            </div>
                            <div class="sec6_item_title">Дата и локация:</div>
                            <div class="sec6_item_text2">
                                28 сентября 2019 года, Halyk Arena
                            </div>
                            <div class="sec6_item_title">Оборудование:</div>
                            <div class="sec6_item_text2">
                                звуковое оборудование, Бэклайн и система PA
                            </div>
                            <a href="#" target="_blank" class="sec6_item_href">Ссылка мероприятия</a>
                        </div>
                    ...
                    <div class="sec6_info_item" data-im="2">
                        <div class="sec6_item_top">
                            <div class="sec6_item_title">Название:</div>
                            <div class="sec6_item_text1">
                                <span>Концерт</span> Jah Khalib 2019
                    ...
                    <div class="sec6_info_item" data-im="3">
                        <div class="sec6_item_top">
                            <div class="sec6_item_title">Название:</div>
                            <div class="sec6_item_text1">
                                <span>Концерт</span> Jah Khalib 2019
                ...
                <div class="sec6_info_slider owl-carousel" id="sec6sl2">
                    <div class="sec6_info_item" data-im="1">
                        <div class="sec6_item_top">
                            <div class="sec6_item_title">Название:</div>
                            <div class="sec6_item_text1">
                                <span>Конференция</span> Jah Khalib 2019
                            </div>
                            <div class="sec6_item_title">Дата и локация:</div>
                            <div class="sec6_item_text2">
                                28 сентября 2019 года, Halyk Arena
                ...
                <div class="sec6_info_slider owl-carousel" id="sec6sl3">
                    <div class="sec6_info_item" data-im="1">
                        <div class="sec6_item_top">
                            <div class="sec6_item_title">Название:</div>
                            <div class="sec6_item_text1">
                                <span>Мероприятия</span> Jah Khalib 2019
                            </div>
                            <div class="sec6_item_title">Дата и локация:</div>
                            <div class="sec6_item_text2">
                                28 сентября 2019 года, Halyk Arena
        ...
        <div class="sec7_box_left">
            ...
            <div class="sec7_left_info flex">
                ...
                <div class="sec7_left_item active">
                    ...
                    <div class="sec7_litem_title">Заключающий этап:</div>
            ...
            <div class="sec7_right_info owl-carousel" id="sec7slider">
                <div class="sec7_right_item flex">
                    <div class="sec7_ritem_img">
                        <img src="{{ asset('img/admin/sec7_im.jpg') }}">
                    </div>
